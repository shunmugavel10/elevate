...
Widget vendorDisplayLV (BuildContext context,VendorContent vendorsData){
                ...
                children: [
                  Center(
                      child: CachedNetworkImage(
                          ...
                          imageUrl: vendorsData.thumbnail.url 
                      ),
                    ),
                 ...
                 SizedBox(width:ResponsiveFlutter.of(context).scale(160),
                      height: ResponsiveFlutter.of(context).fontSize(5),
                          child: Text(vendorsData.name.english,
                  ...
                  Padding(
                    ...
                    child: Text(
                      vendorsData.description.english,
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      style: _styleBody2,
                    ),
