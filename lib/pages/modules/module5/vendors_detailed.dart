...
class VendorDetailed extends StatefulWidget {
  final VendorContent vendorData;

  const VendorDetailed({Key key, this.vendorData}) : super(key: key);

  @override
  _VendorDetailedState createState() => _VendorDetailedState();
}

class _VendorDetailedState extends State<VendorDetailed> {

  PageController _pageController=PageController();
  List<Widget> images=[];
  VendorContent vendorData;

  // List<String> categoryList=["FPO","MFPO"];

  addImage(){
    for(int i=0;i<vendorData.thumbnail.images.length;i++){
      images.add(CachedNetworkImage(
          ...
          imageUrl:vendorData.thumbnail.images[i]),);
    }
        ...
        child: SingleChildScrollView(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              Center(child: indicator(context,_pageController, widget.vendorData.thumbnail.images.length)),
              SizedBox(height: 15,),
              Text(widget.vendorData.name.english,
              ...
              Padding(
                ...
                child: SizedBox(width: _width,
                  child: Text(vendorData.name.english,
              ...
              //             Text(vendorData.billingAddress.type==1?"fd_account_home":"fd_account_work",
