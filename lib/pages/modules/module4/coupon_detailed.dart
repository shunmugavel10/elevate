...
class CouponDetailed extends StatefulWidget {
  final CouponContent couponData;

  const CouponDetailed({Key key, this.couponData}) : super(key: key);

  @override
  _CouponDetailedState createState() => _CouponDetailedState();
}

class _CouponDetailedState extends State<CouponDetailed> {
  ...
  addImage(){
    for(int i=0;i<couponData.image.length;i++){
        ...
        child: SingleChildScrollView(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              Center(child: indicator(context,_pageController, widget.couponData.image.length)),
              SizedBox(height: 15,),
              Text(widget.couponData.name,
